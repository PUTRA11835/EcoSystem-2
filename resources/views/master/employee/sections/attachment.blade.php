    ...
    <div>
        ...
        <div class="grid grid-cols-6 gap-4">
            ...
            <div class="col-span-2">
                ...
                <div class="relative">
                    <select id="attachDocumentType" class="w-full px-3 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-800 bg-white pr-10 appearance-none">
                        <option value="">Select Type</option>
                        <option value="KTP">KTP / ID Card</option>
                        <option value="NPWP">NPWP</option>
                        <option value="BPJS Kesehatan">BPJS Kesehatan</option>
                        <option value="BPJS Ketenagakerjaan">BPJS Ketenagakerjaan</option>
                        <option value="Ijazah">Ijazah / Diploma</option>
                        ...
                        <option value="Surat Referensi">Surat Referensi</option>
    ...
    async function submitAttachment() {
        ...
        try {
            ...
            if (data.success) {
                ...
                // Reset form
                document.getElementById('attachDocumentType').value = '';
