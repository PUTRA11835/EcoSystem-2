...
const PRIORITY_CLS = {
    Low:        { cls: 'bg-gray-50 text-gray-500 ring-1 ring-gray-200',     dot: 'bg-gray-400' },
    Medium:     { cls: 'bg-blue-50 text-blue-700 ring-1 ring-blue-200',     dot: 'bg-blue-400' },
    High:       { cls: 'bg-red-50 text-red-700 ring-1 ring-red-200',        dot: 'bg-red-400' },
    'Very High':{ cls: 'bg-purple-50 text-purple-700 ring-1 ring-purple-200', dot: 'bg-purple-400' },
};
...
function taskRows(t) {
    ...
    const st      = STATUS_BADGE[t.status] ?? { text: t.status, dot: 'bg-gray-400', cls: 'bg-gray-50 text-gray-500 ring-1 ring-gray-200' };
    const prInfo  = PRIORITY_CLS[t.ticket_priority] ?? { cls: 'bg-gray-50 text-gray-500 ring-1 ring-gray-200', dot: 'bg-gray-400' };
