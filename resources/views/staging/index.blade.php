...
function fillModal(s) {
    ...
    if (bodySource) {
        ...
        if (iframe) {
            ...
            // Jika ada graph_message_id, selalu ambil dari previewBody untuk resolve inline images
            // dan (untuk kasus email_body_html kosong) mendapatkan body dari Graph langsung.
            if (s.graph_message_id && s.id) {
                if (bodySource) setIframeContent(bodySource); // tampilkan sementara
