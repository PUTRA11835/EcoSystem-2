...
<div class="bg-white rounded-xl p-6 shadow-sm">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 pb-4 border-b-2 border-gray-100">
        <div><h2 class="text-2xl font-bold text-gray-900">Employee Address</h2><p class="text-sm text-gray-500 mt-1">Daftar alamat seluruh employee</p></div>
        <input type="text" id="searchInput" placeholder="Cari nama / kota / provinsi..." oninput="filterRows()" class="w-full sm:w-72 px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-800">
    </div>
