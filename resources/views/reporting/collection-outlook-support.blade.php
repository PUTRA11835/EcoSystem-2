...
<div class="bg-white rounded-xl p-6 shadow-sm">
    ...
    <div class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-4 mb-6 pb-4 border-b-2 border-gray-100">
        ...
        <div class="flex flex-wrap items-end gap-3">
            ...
            <button onclick="exportOutlook()" id="coExportBtn"
                class="inline-flex items-center gap-1.5 px-4 py-2 bg-green-600 text-white text-sm font-semibold rounded-lg hover:bg-green-700 transition-all duration-200">
